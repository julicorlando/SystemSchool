        ...
        case 'criar_evento':
            if (verificar_permissao($usuario_tipo, ['admin', 'professor'])) {
                ...
                if ($stmt->execute()) {
                    ...
                    $_SESSION['msg_erro'] = 'Erro ao criar evento.';
                }
            }
            break;
            ...
            if (verificar_permissao($usuario_tipo, ['admin', 'professor'])) {
                ...
                if ($verificar->num_rows > 0) {
                    ...
                    if ($stmt->execute()) {
                        ...
                        $_SESSION['msg_erro'] = 'Erro ao atualizar evento.';
                    }
                } else {
...
$mes = $_GET['mes'] ?? date('n');
$ano = $_GET['ano'] ?? date('Y');
$turma_filtro = $_GET['turma_id'] ?? '';

// Construir WHERE baseado nas permissões
$where_permissao = "";
